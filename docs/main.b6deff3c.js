 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o5{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.iu(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.iu(this.observer.error,e):x("Uncaught Error in snapshot listener:",e.toString()))}su(){this.muted=!0}iu(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o3{constructor(e,t){this.ou=e,this.serializer=t,this.metadata=new R,this.buffer=new Uint8Array,this._u=new TextDecoder("utf-8"),this.au().then(e=>{e&&e.Ea()?this.metadata.resolve(e.Ia.metadata):this.metadata.reject(Error(`The first element of the bundle is not a metadata, it is
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eA(e){return e&&e._delegate?e._delegate:e}},{d07263985281b344:"5QIF0","@parcel/transformer-js/src/esmodule-helpers.js":"k3151"}],"2Swcv":[function(e,t,r,n){/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function t6(e,t,r){let n=eB(e),i={requestType:"EMAIL_SIGNIN",email:t,clientType:"CLIENT_TYPE_WEB"};k(r.handleCodeInApp,n,"argument-error"),r&&tW(n,i,r),await eX(n,i,"getOobCode",tn,"EMAIL_PASSWORD_PROVIDER")}function t5(e,t){let r=tm.parseLink(t);return(null==r?void 0:r.operation)==="EMAIL_SIGNIN"}async function t3(e,t,r){if((0,a._isFirebaseServerApp)(e.app))return Promise.reject(S(e));let n=(0,o.getModularInstance)(e),i=tv.credentialWithLink(t,r||R());return k(i._tenantId===(n.tenantId||null),n,"tenant-id-mismatch"),tB(n,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
