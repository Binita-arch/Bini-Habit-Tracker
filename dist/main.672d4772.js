...
function loadHabits() {
    ...
    if (habits.length === 0) return; // Don't display anything if no habits exist
    habits.forEach((habit, index)=>{
        ...
        streakSpan.textContent = `\u{1F525} Streak: ${habit.streak} days`;
...
function checkIn(index) {
    ...
    if (habits[index].lastCheckIn === yesterday.toDateString()) habits[index].streak += 1;
    else habits[index].streak = 1;
...
//# sourceMappingURL=main.672d4772.js.map
